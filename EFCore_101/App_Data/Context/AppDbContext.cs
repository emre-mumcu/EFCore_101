...
namespace EFCore_101.App_Data.Context
{
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder.UseSqlServer(connectionString:
                    App.Instance.DataConfiguration.GetSection("Database:ConnectionString").Value
                );
            }
        }
    ...
    public partial class AppDbContext : DbContext
    {
        ...
        public DbSet<SBB> SBBler => Set<SBB>();
    ...
    public static class DbContextExtensions
    {
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            // This type of initialization makes migrations time longer.
            // Data seeding below will be transferred to DataSeeder class

            

            //// IL
            //var iller = JsonConvert.DeserializeObject<List<IL>>(System.IO.File.ReadAllText(
            //    System.IO.Path.Combine(Environment.CurrentDirectory, "wwwroot", "static", "IL.json")));
            //modelBuilder.Entity<IL>().HasData(iller);

            //// ILCE
            //var ilceler = JsonConvert.DeserializeObject<List<ILCE>>(System.IO.File.ReadAllText(
            //    System.IO.Path.Combine(Environment.CurrentDirectory, "wwwroot", "static", "ILCE.json")));
            //modelBuilder.Entity<ILCE>().HasData(ilceler);

            //// SBB
            //var sbbler = JsonConvert.DeserializeObject<List<SBB>>(System.IO.File.ReadAllText(
            //    System.IO.Path.Combine(Environment.CurrentDirectory, "wwwroot", "static", "SBB.json")));
            //modelBuilder.Entity<SBB>().HasData(sbbler);

            //// MAHALLE
            //var mahalleler = JsonConvert.DeserializeObject<List<MAHALLE>>(System.IO.File.ReadAllText(
            //    System.IO.Path.Combine(Environment.CurrentDirectory, "wwwroot", "static", "MAHALLE.json")));
